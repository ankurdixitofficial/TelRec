    	...
    	<header id="header" class="clear">
    		...
    		<div id="contact">
    			<div class="email">
    				...
    				<a class="hide-href-print" href="mailto:john@gmail.com">john@gmail.com</a>
    			</div>
    			<div class="phone">
    		...
    		<div id="profiles">
    			<div class="item">
    				<div class="username">
    					<span class="fa-brands fa-twitter twitter social"></span>
    					<span class="url">
    						<a target="_blank" href="https://twitter.com/john"><span class="show-only-url-print">john</span></a>
    					</span>
    				</div>
    			</div>
    		</div>
        ...
        <header>
          <h2 class="section-title">summary</h2>
    		...
    		<section class="main-summary">
    			<div><p><p>A summary of John Doe…</p></p></div>
    		</section>
    	</section>
    ...
    <section class="section">
      ...
      <section id="work">
        <section class="work-item">
            ...
            <header class="clear">
              <div class="date">
                <span class="startDate">Jan 2013</span>
                <span class="endDate">- Jan 2014</span>
              </div>
          ...
          <span class="url">
            ...
            <a target="_blank" href="https://company.com">https://company.com</a>
          </span>        <div class="item" id="work-item">
            <div class="summary"><p><p>Description…</p></p></div>
            <ul class="highlights">
              <li><p><p>Started the company</p></p></li>
            </ul>
          </div>
        </section>
      </section>
    ...
    <section class="section">
      ...
      <section id="projects">
        <section class="project-item">
          ...
          <header class="clear">
            <div class="position">Project</div>
            <div class="date">
              <span class="startDate">Jan 2019</span>
              <span class="endDate">- Jan 2021</span>
            </div>
          </header>
          <span class="website">
            <span class="fa-solid fa-up-right-from-square"></span>
            <a target="_blank" href="https://project.com/">https://project.com/</a>
          </span>
          <div class="item">
            <ul class="highlights">
                <li><p><p>Won award at AIHacks 2016</p></p></li>
            </ul>
          </div>
        </section>
      </section>
      ...
      <section id="volunteer">
        <section class="volunteer-item">
          ...
          <div class="item">
            <div class="summary"><p><p>Description…</p></p></div>
            <ul class="highlights">
              <li><p><p>Awarded 'Volunteer of the Month'</p></p></li>
            </ul>
          </div>
        </section>
      </section>
      ...
      <section class="section">
        ...
        <section id="awards">
            <section class="award-item">
              ...
              <div class="item">
                  <div class="summary"><p><p>There is no spoon.</p></p></div>
              </div>
            </section>
        </section>
      </section>
        ...
        <section id="certificates">
            <section class="certificate-item">
              ...
              <div class="item">
                  <span class="url">
                    <span class="fa-solid fa-up-right-from-square"></span>
                    <a target="_blank" href="https://certificate.com">https://certificate.com</a>
                  </span>
              </div>
            </section>
        </section>
